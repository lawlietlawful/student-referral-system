...
@section('page-title', 'Edit Seminar Details')
@section('page-sub', 'Update information for the intervention seminar')
...
<div class="bg-white border border-gray-100 rounded-2xl shadow-premium max-w-4xl">
    <div class="px-6 py-5 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
        <h3 class="font-semibold text-gray-800 text-lg flex items-center gap-2">
            <i class="ti ti-calendar-edit text-blue-600"></i> Seminar Details
        </h3>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $seminar->title) }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="date" name="date" id="date" value="{{ old('date', $seminar->date->format('Y-m-d')) }}" required
                    ...
                    <div>
                        ...
                        <input type="time" name="time" id="time" value="{{ old('time', \Carbon\Carbon::parse($seminar->time)->format('H:i')) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="venue" id="venue" value="{{ old('venue', $seminar->venue) }}" required
                ...
                <div class="bg-gray-50/50 p-4 rounded-xl border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="target_course" id="target_course" value="{{ old('target_course', $seminar->target_course) }}" placeholder="e.g. BSIT (Optional)"
                        ...
                        <div>
                            ...
                            <input type="number" name="max_participants" id="max_participants" value="{{ old('max_participants', $seminar->max_participants) }}" min="1"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="speaker" id="speaker" value="{{ old('speaker', $seminar->speaker) }}"
                    ...
                    <div class="flex items-center pt-6">
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <input type="checkbox" name="is_required" value="1" class="sr-only peer" {{ old('is_required', $seminar->is_required) ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition shadow-sm @error('description') border-red-500 @enderror">{{ old('description', $seminar->description) }}</textarea>
                </div>
            </div>

            <div class="mt-8 flex items-center justify-end gap-3 pt-5 border-t border-gray-100">
                <a href="{{ route('admin.seminars.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                    Cancel
                </a>
