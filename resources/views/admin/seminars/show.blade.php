...
<div class="mb-6 flex items-center justify-between" x-data="{ showQrModal: false }">
    ...
    <div class="flex gap-3">
        ...
        <a href="{{ route('admin.seminars.edit', $seminar->id) }}" class="inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition shadow-sm gap-2">
